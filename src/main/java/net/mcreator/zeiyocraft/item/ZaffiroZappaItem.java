...
public class ZaffiroZappaItem extends ZeiyocraftModElements.ModElement {
	@ObjectHolder("zeiyocraft:zaffiro_zappa")
	public static final Item block = null;
	public ZaffiroZappaItem(ZeiyocraftModElements instance) {
		super(instance, 42);
	}
