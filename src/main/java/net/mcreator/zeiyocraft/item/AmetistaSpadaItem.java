...
public class AmetistaSpadaItem extends ZeiyocraftModElements.ModElement {
	@ObjectHolder("zeiyocraft:ametista_spada")
	public static final Item block = null;
	public AmetistaSpadaItem(ZeiyocraftModElements instance) {
		super(instance, 20);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("ametista_spada"));
	}
}
