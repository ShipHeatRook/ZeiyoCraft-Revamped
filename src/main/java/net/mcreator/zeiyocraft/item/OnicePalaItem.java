...
public class OnicePalaItem extends ZeiyocraftModElements.ModElement {
	@ObjectHolder("zeiyocraft:onice_pala")
	public static final Item block = null;
	public OnicePalaItem(ZeiyocraftModElements instance) {
		super(instance, 55);
	}
