...
public class GiadaPalaItem extends ZeiyocraftModElements.ModElement {
	@ObjectHolder("zeiyocraft:giada_pala")
	public static final Item block = null;
	public GiadaPalaItem(ZeiyocraftModElements instance) {
		super(instance, 312);
	}
