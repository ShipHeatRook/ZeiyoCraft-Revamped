...
public class RubinoSpadaItem extends ZeiyocraftModElements.ModElement {
	@ObjectHolder("zeiyocraft:rubino_spada")
	public static final Item block = null;
	public RubinoSpadaItem(ZeiyocraftModElements instance) {
		super(instance, 21);
	}
