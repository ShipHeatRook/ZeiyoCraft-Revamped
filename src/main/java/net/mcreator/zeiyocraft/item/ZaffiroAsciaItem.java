...
public class ZaffiroAsciaItem extends ZeiyocraftModElements.ModElement {
	@ObjectHolder("zeiyocraft:zaffiro_ascia")
	public static final Item block = null;
	public ZaffiroAsciaItem(ZeiyocraftModElements instance) {
		super(instance, 41);
	}
