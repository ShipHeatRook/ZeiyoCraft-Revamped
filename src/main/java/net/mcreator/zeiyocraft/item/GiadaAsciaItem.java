...
public class GiadaAsciaItem extends ZeiyocraftModElements.ModElement {
	@ObjectHolder("zeiyocraft:giada_ascia")
	public static final Item block = null;
	public GiadaAsciaItem(ZeiyocraftModElements instance) {
		super(instance, 309);
	}
