...
public class OniceSpadaItem extends ZeiyocraftModElements.ModElement {
	@ObjectHolder("zeiyocraft:onice_spada")
	public static final Item block = null;
	public OniceSpadaItem(ZeiyocraftModElements instance) {
		super(instance, 23);
	}
