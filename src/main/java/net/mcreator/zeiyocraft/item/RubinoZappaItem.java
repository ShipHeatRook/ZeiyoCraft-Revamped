...
public class RubinoZappaItem extends ZeiyocraftModElements.ModElement {
	@ObjectHolder("zeiyocraft:rubino_zappa")
	public static final Item block = null;
	public RubinoZappaItem(ZeiyocraftModElements instance) {
		super(instance, 58);
	}
