...
public class RubinoAsciaItem extends ZeiyocraftModElements.ModElement {
	@ObjectHolder("zeiyocraft:rubino_ascia")
	public static final Item block = null;
	public RubinoAsciaItem(ZeiyocraftModElements instance) {
		super(instance, 57);
	}
