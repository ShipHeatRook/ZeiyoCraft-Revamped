...
public class PipaItem extends ZeiyocraftModElements.ModElement {
	@ObjectHolder("zeiyocraft:pipa")
	public static final Item block = null;
	public PipaItem(ZeiyocraftModElements instance) {
		super(instance, 74);
	}
