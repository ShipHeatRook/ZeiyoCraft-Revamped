...
public class OniceAsciaItem extends ZeiyocraftModElements.ModElement {
	@ObjectHolder("zeiyocraft:onice_ascia")
	public static final Item block = null;
	public OniceAsciaItem(ZeiyocraftModElements instance) {
		super(instance, 53);
	}
