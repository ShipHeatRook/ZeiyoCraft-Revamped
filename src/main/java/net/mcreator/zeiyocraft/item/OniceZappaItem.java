...
public class OniceZappaItem extends ZeiyocraftModElements.ModElement {
	@ObjectHolder("zeiyocraft:onice_zappa")
	public static final Item block = null;
	public OniceZappaItem(ZeiyocraftModElements instance) {
		super(instance, 54);
	}
