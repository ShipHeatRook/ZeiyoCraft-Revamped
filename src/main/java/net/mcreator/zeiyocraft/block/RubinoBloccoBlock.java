...
public class RubinoBloccoBlock extends ZeiyocraftModElements.ModElement {
	@ObjectHolder("zeiyocraft:rubino_blocco")
	public static final Block block = null;
	public RubinoBloccoBlock(ZeiyocraftModElements instance) {
		super(instance, 294);
	}
