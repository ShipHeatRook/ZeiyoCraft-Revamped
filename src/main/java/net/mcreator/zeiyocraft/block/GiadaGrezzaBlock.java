...
public class GiadaGrezzaBlock extends ZeiyocraftModElements.ModElement {
	@ObjectHolder("zeiyocraft:giada_grezza")
	public static final Block block = null;
	public GiadaGrezzaBlock(ZeiyocraftModElements instance) {
		super(instance, 298);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("zeiyocraft:giada_grezza_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("giada_grezza"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("zeiyocraft:giada_grezza"), configuredFeature);
		}
	}
	@SubscribeEvent
