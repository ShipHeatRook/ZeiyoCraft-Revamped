...
public class ArgentoBloccoBlock extends ZeiyocraftModElements.ModElement {
	@ObjectHolder("zeiyocraft:argento_blocco")
	public static final Block block = null;
	public ArgentoBloccoBlock(ZeiyocraftModElements instance) {
		super(instance, 12);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("argento_blocco");
		}
