...
public class RubinoGrezzoBlock extends ZeiyocraftModElements.ModElement {
	@ObjectHolder("zeiyocraft:rubino_grezzo")
	public static final Block block = null;
	public RubinoGrezzoBlock(ZeiyocraftModElements instance) {
		super(instance, 16);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("zeiyocraft:rubino_grezzo_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("rubino_grezzo"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("zeiyocraft:rubino_grezzo"), configuredFeature);
		}
	}
	@SubscribeEvent
