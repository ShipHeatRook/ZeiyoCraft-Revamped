...
public class MadreperlaBloccoBlock extends ZeiyocraftModElements.ModElement {
	@ObjectHolder("zeiyocraft:madreperla_blocco")
	public static final Block block = null;
	public MadreperlaBloccoBlock(ZeiyocraftModElements instance) {
		super(instance, 342);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("madreperla_blocco");
		}
