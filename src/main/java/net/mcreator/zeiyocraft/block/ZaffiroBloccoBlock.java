...
public class ZaffiroBloccoBlock extends ZeiyocraftModElements.ModElement {
	@ObjectHolder("zeiyocraft:zaffiro_blocco")
	public static final Block block = null;
	public ZaffiroBloccoBlock(ZeiyocraftModElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("zaffiro_blocco");
		}
