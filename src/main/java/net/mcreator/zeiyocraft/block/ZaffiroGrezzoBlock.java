...
public class ZaffiroGrezzoBlock extends ZeiyocraftModElements.ModElement {
	@ObjectHolder("zeiyocraft:zaffiro_grezzo")
	public static final Block block = null;
	public ZaffiroGrezzoBlock(ZeiyocraftModElements instance) {
		super(instance, 3);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("zaffiro_grezzo");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("zeiyocraft:zaffiro_grezzo_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("zaffiro_grezzo"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("zeiyocraft:zaffiro_grezzo"), configuredFeature);
		}
	}
	@SubscribeEvent
