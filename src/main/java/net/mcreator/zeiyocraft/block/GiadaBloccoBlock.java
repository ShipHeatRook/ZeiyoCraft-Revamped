...
public class GiadaBloccoBlock extends ZeiyocraftModElements.ModElement {
	@ObjectHolder("zeiyocraft:giada_blocco")
	public static final Block block = null;
	public GiadaBloccoBlock(ZeiyocraftModElements instance) {
		super(instance, 319);
	}
