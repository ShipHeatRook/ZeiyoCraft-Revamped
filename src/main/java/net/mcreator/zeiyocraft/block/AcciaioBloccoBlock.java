...
public class AcciaioBloccoBlock extends ZeiyocraftModElements.ModElement {
	@ObjectHolder("zeiyocraft:acciaio_blocco")
	public static final Block block = null;
	public AcciaioBloccoBlock(ZeiyocraftModElements instance) {
		super(instance, 296);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("acciaio_blocco");
		}
