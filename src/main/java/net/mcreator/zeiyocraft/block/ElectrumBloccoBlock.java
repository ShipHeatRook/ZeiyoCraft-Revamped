...
public class ElectrumBloccoBlock extends ZeiyocraftModElements.ModElement {
	@ObjectHolder("zeiyocraft:electrum_blocco")
	public static final Block block = null;
	public ElectrumBloccoBlock(ZeiyocraftModElements instance) {
		super(instance, 13);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("electrum_blocco");
		}
