...
public class OniceBloccoBlock extends ZeiyocraftModElements.ModElement {
	@ObjectHolder("zeiyocraft:onice_blocco")
	public static final Block block = null;
	public OniceBloccoBlock(ZeiyocraftModElements instance) {
		super(instance, 15);
	}
